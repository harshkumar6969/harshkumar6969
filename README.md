...
🚀 Built multiple full-stack projects using modern technologies
...
A modern drag-and-drop form builder with authentication and responsive UI.

### 🌐 SyncSphere
A real-time collaboration platform built using Socket.IO, Express.js and MongoDB.

### 🏫 Smart Campus Utility App
A student utility platform with a clean and responsive interface.

### 📸 Mini Instagram Clone
A full-stack social media application with authentication and image uploads.
...
<p align="center">
<img src="https://readme-typing-svg.herokuapp.com?lines=Thanks+for+visiting!;Keep+Building+🚀;Keep+Learning+💡&center=true&width=550&height=45&color=00F7FF&vCenter=true&size=22">
</p>
